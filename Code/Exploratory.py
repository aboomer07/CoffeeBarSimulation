...
df['onetime'] = np.where(df['customer']
                         .isin(time_frame['customer'].unique()), 0, 1)
...
plt.stackplot(probs_df['time'], *[probs_df[col] for col in food_list],
...
plt.stackplot(probs_df['time'], *[probs_df[col] for col in drink_list],
